...
/// </summary>
public class CollissionControllerMultiplayer : CollisionControler
{

    MultiPlayerController thePlayer;
    ...
    void Start()
    {
        thePlayer = (MultiPlayerController)GetComponent<MultiPlayerController>();
            ...
            switch (identifierTag)
            {
                ...
                case 3:
                    ...
                    if (orientation == 'y')
                    {
                        ...
                        ProvisionalVector = thePlayer.velocity;
                        ProvisionalVector.y = thePlayer.enemyDeathRepulsionVelY;
                        thePlayer.velocity = ProvisionalVector;
                    }
